#####################################
#        WRUMS WS 2018/2019         #
#   L�sungsvorschlag f�r Blatt 1    #
#####################################

## Aufgabe 1:
# a)
# Patientennummer:      Ordinal, falls nummeriert. Nominal, falls verschl�sselt.
# Vorname:              Nominal
# Nachname:             Nominal
# Geschlecht:           Nominal (ggf. bin�r)
...
#                         m�glich. Bspw. Umwandlung in Tage seit Neujahr
# Namen der Mannschaften: Nominal
# Tore der Mannschaften:  Quantitativ diskret
# Ex. Uhrzeit d Ansto�es: Sonderfall. Zuerst Nominal, Umwandlung in Quantitativ 
#                         m�glich. Bspw. Umwandlung in Minuten oder Sekunden 
#                         seit Mittag.
# Tabellenpl�tze:         Ordinal
...
# c)
# A und C �hneln sich stark bez�glich Lage und Streuung. 
# B ist daher die Ausrei�ergruppe.
